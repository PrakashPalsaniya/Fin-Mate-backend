...
const { serializeUser } = require("../auth/user.serializer.js");
const { createTransaction, TransactionServiceError } = require("../../shared/services/transaction.service.js");
const {
    getFinancialSummary,
...
} = require("./services/telegramConfig.js");
const {
    answerCallbackQuery,
    editMessageText,
...
const {
    ...
    unlinkTelegramChat,
} = require("./services/telegramLinkService.js");
const {
...
} = require("./services/telegramIntentService.js");
const { parseTelegramTransactionMessage } = require("./services/telegramParserService.js");
const {
...
} = require("./services/telegramMessageService.js");
